        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <a
                href={getWhatsAppUrl("Hola, me gustaría agendar una sesión inicial de diagnóstico.")}
                target="_blank"
                rel="noopener noreferrer"
                className="font-sans font-bold text-base px-7 py-3.5 rounded-full bg-[var(--ink)] text-[var(--paper)] hover:bg-[var(--ink-soft)] hover:scale-[1.02] shadow-lg transition-all flex items-center gap-3 border border-[var(--ink)]"
              >
                <span>💬</span> Agendar Sesión ({brand.pricing.remoteSession.formattedPrice})
              </a>
