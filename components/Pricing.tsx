  ...
  const plans = [
    {
      ...
      whatsappMsg: "Hola, me interesa agendar una Sesión Remota de $19.990.",
      featured: false,
    },
    {
      ...
      whatsappMsg: "Hola, me interesa la Sesión Presencial a domicilio de $34.990.",
      featured: false,
    },
    {
      ...
      ctaText: "Cotizar Plan Pyme",
      whatsappMsg: "Hola, me interesa cotizar el plan de Mantención Pyme.",
      featured: true,
    },
  ];
    ...
    <section id="planes" className="py-16 sm:py-24 bg-grid-paper border-b border-[var(--line)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="pt-6 border-t border-[var(--line)] mt-8">
                <a
                  ...
                  className={`w-full font-sans font-bold text-sm py-3.5 px-4 rounded-full text-center transition-all flex items-center justify-center gap-2 border border-[var(--ink)] ${
                    plan.featured
                      ? "bg-[var(--blue)] text-white hover:bg-[var(--ink)] shadow-md"
                      : "bg-[var(--ink)] text-[var(--paper)] hover:bg-[var(--ink-soft)]"
                  }`}
                >
                  <span>💬</span> {plan.ctaText}
                </a>
              </div>
            </div>
          ))}
        ...
        <div className="rounded-2xl border-2 border-[var(--ink)] bg-[var(--paper-2)] p-6 sm:p-8 shadow-[6px_6px_0px_0px_var(--ink)] flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href={getWhatsAppUrl("Hola, requiero una cotización especial para una flota de computadores.")}
            target="_blank"
            rel="noopener noreferrer"
            className="font-sans font-bold text-xs px-6 py-3.5 rounded-full bg-[var(--ink)] text-white hover:bg-[var(--ink-soft)] shrink-0 transition-colors border border-[var(--ink)]"
          >
