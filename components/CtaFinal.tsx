      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-3xl bg-[var(--ink)] text-[var(--paper)] p-8 sm:p-14 lg:p-16 border-2 border-[var(--ink)] shadow-[10px_10px_0px_0px_var(--orange)] relative overflow-hidden flex flex-col items-center text-center gap-8">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 pt-2">
            <a
              href={getWhatsAppUrl("Hola, me gustaría agendar la sesión inicial ahora.")}
              target="_blank"
              rel="noopener noreferrer"
              className="font-sans font-bold text-base px-8 py-4 rounded-full bg-[var(--orange)] text-white hover:bg-[var(--white)] hover:text-[var(--ink)] shadow-lg hover:scale-105 transition-all flex items-center gap-3 border border-[var(--orange)]"
            >
              <span>💬</span> Agendar por WhatsApp ({brand.pricing.remoteSession.formattedPrice})
            </a>
          </div>
